...
<h3 align="center">
Desenvolvedor Full Stack Java • Spring Boot • React • JavaScript
</h3>

<p align="center">
Transformando ideias em aplicações web modernas.
</p>
...
🎓 Formado no curso Full Stack Java da EBAC

🌱 Atualmente estudando arquitetura de software, microsserviços e boas práticas de desenvolvimento.

❤️ Apaixonado por desenvolvimento web e criação de APIs REST.
...
- 📚 **ContentHub API**
  - API REST para gerenciamento de conteúdo utilizando Spring Boot, JWT e PostgreSQL.

- ⛪ **Sistema de Gerenciamento para Igreja**
  - Sistema Full Stack para eventos, membros, ministérios e administração.

- 🛍️ **Achadinhos Shopee**
  - Plataforma integrada com Google Sheets para gerenciamento automático de produtos.
